...
public class ExponentiallyProfiledArmSubsystem extends SubsystemBase
{
  ...
  private final SparkMax         armMotor           = new SparkMax( ArmConstants.MOTOR_ID, MotorType.kBrushless);
  ///  Configuration Options
  private final DCMotor          dcMotor            = DCMotor.getNEO(1);
  private final MechanismGearing gearing            = new MechanismGearing(630);
  private final Mass             weight             = Pounds.of(110);
  private final Distance         length             = Feet.of(0.954);
  /*
   ...
   */
  private final Angle            softLowerLimit     = ArmConstants.softminAngle;
  private final Angle            softUpperLimit     = ArmConstants.softmaxAngle;
  /*
   * These are the real "limits" of the robot shown in simulation.
   */
  private final Angle            hardLowerLimit     = ArmConstants.minAngle;
  private final Angle            hardUpperLimit     = ArmConstants.maxAngle;
